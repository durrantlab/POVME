...
if literal_eval(os.environ.get("POVME_LOG", "False")):
    level = int(os.environ.get("POVME_LOG_LEVEL", 20))
    stdout = literal_eval(os.environ.get("POVME_STDOUT", "True"))
    log_file_path = os.environ.get("POVME_LOG_FILE_PATH", None)
